...
ZIG_EXTERN_C int32_t add(int32_t a0, int32_t a1);
ZIG_EXTERN_C void os_unfair_lock_lock(zig_S_c_darwin_os_unfair_lock * a0);
ZIG_EXTERN_C intptr_t write(int a0, uint8_t const * a1, uintptr_t a2);
ZIG_EXTERN_C void os_unfair_lock_unlock(zig_S_c_darwin_os_unfair_lock * a0);
ZIG_EXTERN_C zig_noreturn void abort(void);
ZIG_EXTERN_C uint32_t _dyld_image_count(void);
ZIG_EXTERN_C uintptr_t _dyld_get_image_vmaddr_slide(uint32_t a0);
ZIG_EXTERN_C zig_S_macho_mach_header * _dyld_get_image_header(uint32_t a0);
ZIG_EXTERN_C uint8_t const * _dyld_get_image_name(uint32_t a0);
ZIG_EXTERN_C int * __error(void);
ZIG_EXTERN_C int pthread_threadid_np(void * a0, uint64_t * a1);
ZIG_EXTERN_C void * mmap(void * a0, uintptr_t a1, unsigned int a2, unsigned int a3, int a4, int64_t a5);
ZIG_EXTERN_C int __ulock_wait2(uint32_t a0, void const * a1, uint64_t a2, uint64_t a3, uint64_t a4);
ZIG_EXTERN_C int sigaction(int a0, zig_S_c_darwin_Sigaction const * a1, zig_S_c_darwin_Sigaction * a2);
ZIG_EXTERN_C int close$NOCANCEL(int a0);
ZIG_EXTERN_C intptr_t read(int a0, uint8_t * a1, uintptr_t a2);
ZIG_EXTERN_C int munmap(void const * a0, uintptr_t a1);
ZIG_EXTERN_C uint8_t * getenv(uint8_t const * a0);
ZIG_EXTERN_C int openat(int a0, uint8_t const * a1, unsigned int a2, ...);
ZIG_EXTERN_C int fcntl(int a0, int a1, ...);
ZIG_EXTERN_C int fstat(int a0, zig_S_c_darwin_Stat * a1);
ZIG_EXTERN_C int isatty(int a0);
ZIG_EXTERN_C int msync(void const * a0, uintptr_t a1, int a2);
